...
export default function MessageInput() {
  ...
  return (
    <div className="px-4 pb-4 pt-2 border-t border-[rgba(255,255,255,0.06)]">
      {error && (
        <p className="text-xs text-red-400 mb-1.5 px-1">{error}</p>
      )}
      <div className={`flex items-end gap-2 bg-[rgba(255,255,255,0.05)] border rounded-2xl px-3 py-2 transition-all ${
        disabled ? 'opacity-40 cursor-not-allowed border-[rgba(255,255,255,0.06)]' : 'border-[rgba(255,255,255,0.1)] focus-within:border-[var(--colors-primary)] focus-within:shadow-[0_0_0_2px_rgba(var(--colors-primary-rgb),0.15)]'
      }`}>
        <textarea
